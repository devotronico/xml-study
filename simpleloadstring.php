...
// http://localhost/xml/simpleloadstring.php
...
// Converte ls stringa XML nel formato oggetto SimpleXMLElement
$xmlObject = simplexml_load_string($note); // return SimpleXMLElement Object

// Converte l' oggetto SimpleXMLElement nel formato JSON
$jsonString = json_encode($xmlObject);
 

// Converte il formato JSON in un array associativo
$arr = json_decode($jsonString, true);
 
// var_dump($arr);
// echo '<pre>';print_r( $arr )."<pre>";
echo "<br>=======================<br>";
echo $arr['FatturaElettronicaBody']['DatiGenerali']['DatiGeneraliDocumento']['Data'];
echo "<br><br>";
echo $arr['FatturaElettronicaHeader']['CedentePrestatore']['Sede']['Comune'];
...
echo "<br><br>";
echo "<h3>Sede</h3>";
echo '<pre>';print_r( $arr['FatturaElettronicaHeader']['CedentePrestatore']['Sede'])."<pre>";
echo "<br><br>";
...
function printAll($item, $key)
{
    echo "$key - $item\n";
}

array_walk_recursive($arr, 'printAll');
